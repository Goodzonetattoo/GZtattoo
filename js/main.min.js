...
(function () {
  ...
  if ("querySelector" in document && "addEventListener" in window) {
    ...
    var setupLocations = function setupLocations() {
      content = [];
      forEach(links, function (i, el) {
    ...
    var selectActiveMenuItem = function selectActiveMenuItem(i) {
      forEach(links, function (i, el) {
    ...
    var clearTapCheck = function clearTapCheck() {
      setTimeout(function () {
...
(function (K) {
  ...
  function _22(io, el, _23, _24) {
    ...
    if (io) {
      ...
      new Animate(el, "opacity", { to: 1, time: _23, callback: function callback() {
          _24();
        } });
    } else {
      ...
      new Animate(el, "opacity", { to: 0, time: _23, callback: function callback() {
...
Animate.prototype = { start: function start() {
    var _2a = this;
  ...
  }, _setStyle: function _setStyle(val) {
